      ...
      <div className='testimonials'>
        ...
        <div className='testimonial'>
          ...
          <p className='description'>
            Jetrips Hotel is an excellent choice for anybody for considering hosting their events
            staff make for a brilliant enviroment within which to operate. The hotel is meticulous
            in its planning.
          </p>
        </div>
